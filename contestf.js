...
export default function Contestf() {
    ...
    const uploadToAirtable = async (videoUrl) => {
        ...
        try {
            ...
            const treesUrl = `https://api.airtable.com/v0/appfQNmAs6vTN5iAn/food`;
            ...
            console.log('Video uploaded and record created in the food wastage table.');
        } catch (error) {
    ...
    return (
        <section id="main-cont">
            <div id="docont">
                ...
                <p>
                    Join the {contest} contest and contribute to a more sustainable world by reducing food wastage! This initiative focuses on minimizing food waste through innovative methods such as reusing leftovers, donating surplus food, and spreading awareness about the importance of reducing food wastage.
                </p>
                <h2>Rules & Regulations</h2>
                <ol>
                    <li>Each participant must record a video of their efforts to reduce food waste, such as reusing leftovers or donating food to those in need.</li>
                    <li>The video should clearly show the steps taken to reduce food waste and include creative solutions.</li>
            ...
            <div id="live-camera">
                <h2>Record Your Food Waste Reduction Activity</h2>
